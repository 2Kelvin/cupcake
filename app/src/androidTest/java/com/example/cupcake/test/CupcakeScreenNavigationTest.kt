...
class CupcakeScreenNavigationTest {
    // composeTestRule launches the app for testing
    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()
    private lateinit var navController: TestNavHostController

    @Before // initializes the TestNavHostController before any test
    ...
    // checking if CupcakeScreen.Start.name is the default home page when app launches
    @Test
    fun cupcakeNavHost_verifyStartDestination() {
        navController.assertCurrentRouteName(CupcakeScreen.Start.name)
    }

    // confirming that Start screen has no up (back) button
    @Test
    ...
    // confirming flavor screen is displayed after any of the Start screen buttons is clicked
    @Test
